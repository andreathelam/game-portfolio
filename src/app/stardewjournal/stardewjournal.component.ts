...
export class StardewjournalComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.data.changeName(["Wartorn", "#f3d3d7", "wartorn"], ["New World", "#dddddd", "new-world"], ["CATching Shrooms", "#dacfee", "catching-shrooms"], ["Puzzling Potions","#F5B971", "puzzling-potions"])
